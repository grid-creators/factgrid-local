...
Server-Schlüssel), die Gesprächsablage (Seitenleiste, Löschen) und das DeepSeek-Backend (Chat-Completions-Format, reasoning_content im
Tool-Loop, Zusammensetzen gestreamter Tool-Aufrufe) – ohne echte API-Aufrufe.
"""
